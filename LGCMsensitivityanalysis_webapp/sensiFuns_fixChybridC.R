...
fun.hybridmuC_sr <- function(datpreplist, Mean_C=c(0.39, 0.39, -0.39, -0.39), 
  ...
  muC1.hybrid <- function( i=1 , nboot=1000 ){
  ...
  muC.Kdraws=rmvnorm(K, Mean_C, Sigma_C)
  # nboot=1000
  hybridres = lapply(1:K, muC1.hybrid, nboot=nboot)
...
fun.hybridrC_sr <- function(
  ...
  rC1.hybrid <- function( i=1 , nboot=1000 ){
  ...
  hybridres = lapply(1:K, rC1.hybrid, nboot=nboot)
